...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/lufeng4828/beego/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/lufeng4828/beego/orm.GroupPermissions)"`
}
...
go get -u github.com/lufeng4828/beego/orm
...
go test -v github.com/lufeng4828/beego/orm
